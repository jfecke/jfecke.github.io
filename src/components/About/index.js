...
function About(props) {
  return (
    <Wrapper>
        ...
        <a href="https://docs.google.com/document/d/e/2PACX-1vQAoZiMlNIH07BIpJIN3s9i0fWRbpMWNLrgv_i11wksvx-MYkiMm2MRAE_3qsZTk2frX75IR8x43OpE/pub" target="_blank" rel="noopener noreferrer" className="card card2">
